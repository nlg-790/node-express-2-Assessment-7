...
describe("GET /users", function() {
  ...
  // Bug 4
  test("should only include username, first_name, and last_name for users", async () => {
    // Arrange
    ...
    expect(response.body.users[0]).toEqual(expectedUserData);
  });
...
describe("PATCH /users/[username]", function() {
  ...
  // Bug 1
  test("should patch data if user", async function() {
    const response = await request(app)
      .patch("/users/u1")
